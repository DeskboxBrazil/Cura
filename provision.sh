...
# Graphic environment
sudo apt-get install -y iceweasel lightdm xfce4 virtualbox-guest-modules virtualbox-guest-utils virtualbox-guest-x11 virtualbox-guest-dkms xfce4-terminal -t jessie
